...
# Original Author Source: https://github.com/Disassembler0/Win10-Initial-Setup-Script
...
##########
# O&O Shutup Config and Run
##########

Function OOShutupCFGAndRun {
...
# Install Linux Subsystem - Applicable to 1607 or newerw
